<?php
	// ako category id nije postavljen vrati se na index.php
	if(!isset($_GET['categoryID'])) {
		header("Location:index.php");
	}
	// select svih itema iz baze podataka
	...
	if(mysqli_num_rows($stock_query)==0) {
		...
		<?php do {
			...
			<p><?php echo $stock_rs['price']; ?> kn</p>
			<p><input type="submit" name="potvrda" value="Zainteresiran sam" /></p></a>
			</div>
		<?php
